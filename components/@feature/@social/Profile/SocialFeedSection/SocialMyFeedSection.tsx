...
import { SocialFeedCard } from 'components/@feature/@social/Profile/SocialFeedCard';
import SocialFeedSectionView, {
  CARD_WIDTH,
} from 'components/@feature/@social/Profile/SocialFeedSection/SocialFeedSectionView';
